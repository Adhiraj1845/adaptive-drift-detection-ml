...
All citations for the dissertation on adaptive drift detection for financial time series.
Organised by category. ~70 unique references across 16 categories.
...
Žliobaitė, I. (2010). Learning under concept drift: An overview. Technical Report, Faculty of Mathematics and Informatics, Vilnius University. arXiv:1010.4784.
...
Mouss, H., Mouss, D., Mouss, N. & Sefouhi, L. (2004). Test of Page-Hinkley, an approach for fault detection in an agro-alimentary production system. *Proceedings of the 5th Asian Control Conference*, 815–818.
...
Gama, J., Medas, P., Castillo, G. & Rodrigues, P. (2004). Learning with drift detection. *Proceedings of the 17th Brazilian Symposium on Artificial Intelligence (SBIA 2004)*, LNCS 3171, 286–295. https://doi.org/10.1007/978-3-540-28645-5_29

Baena-García, M., del Campo-Ávila, J., Fidalgo, R., Bifet, A., Gavaldà, R. & Morales-Bueno, R. (2006). Early drift detection method. *Proceedings of the 4th International Workshop on Knowledge Discovery from Data Streams (ECML/PKDD)*, 77–86.

Kifer, D., Ben-David, S. & Gehrke, J. (2004). Detecting change in data streams. *Proceedings of the 30th International Conference on Very Large Data Bases (VLDB)*, 180–191. https://doi.org/10.5555/1316689.1316707

Rabanser, S., Günnemann, S. & Lipton, Z.C. (2019). Failing loudly: An empirical study of methods for detecting dataset shift. *Advances in Neural Information Processing Systems (NeurIPS)*, 32. arXiv:1810.11953.

Nishida, K. & Yamauchi, K. (2007). Detecting concept drift using statistical testing. *Proceedings of the 10th International Conference on Discovery Science*, LNCS 4755, 264–269. https://doi.org/10.1007/978-3-540-75488-6_27
...
Basel Committee on Banking Supervision. (2005). *Studies on the Validation of Internal Rating Systems* (Working Paper No. 14). Bank for International Settlements. https://www.bis.org/publ/bcbs_wp14.pdf

---

## 4. Online and Adaptive Learning

Bottou, L. (1998). Online learning and stochastic approximations. In D. Saad (Ed.), *On-Line Learning in Neural Networks*, 9–42. Cambridge University Press. https://leon.bottou.org/papers/bottou-98x

Herbster, M. & Warmuth, M.K. (1998). Tracking the best expert. *Machine Learning*, 32(2), 151–178. https://doi.org/10.1023/A:1007424614876

Klinkenberg, R. & Joachims, T. (2000). Detecting concept drift with support vector machines. *Proceedings of the 17th International Conference on Machine Learning (ICML)*, 487–494.
...
Kolter, J.Z. & Maloof, M.A. (2007). Dynamic weighted majority: An ensemble method for drifting concepts. *Journal of Machine Learning Research*, 8, 2755–2790. https://jmlr.org/papers/v8/kolter07a.html
...
Young, T.W. (1991). Calmar ratio: A smoother tool. *Futures*, 20(1), 40. *(Trade publication — use as secondary reference only)*
...
Brock, W., Lakonishok, J. & LeBaron, B. (1992). Simple technical trading rules and the stochastic properties of stock returns. *Journal of Finance*, 47(5), 1731–1764. https://doi.org/10.2307/2328994

---

## 12. Probability Calibration

Platt, J. (1999). Probabilistic outputs for support vector machines and comparisons to regularized likelihood methods. In A. Smola et al. (Eds.), *Advances in Large Margin Classifiers*, 61–74. MIT Press.
...
Financial Conduct Authority. (2018). *Algorithmic Trading Compliance in Wholesale Markets*. FCA. https://www.fca.org.uk/publications/multi-firm-reviews/algorithmic-trading-compliance-wholesale-markets

European Parliament. (2014). *Directive 2014/65/EU on Markets in Financial Instruments (MiFID II)*. Official Journal of the European Union. https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32014L0065
...
BCS. (2022). *BCS Code of Conduct*. British Computer Society. https://www.bcs.org/membership-and-registrations/become-a-member/bcs-code-of-conduct/
...
Papers to actually read before writing (not just cite):

| Paper | Why |
|---|---|
| Gama et al. (2014) | Taxonomy used throughout — covariate/concept/recurring drift |
| Widmer & Kubat (1996) | Earliest framework, establishes the vocabulary |
| Bifet & Gavaldà (2007) | ADWIN: justifies data-driven thresholds over fixed ones |
| Rabanser et al. (2019) | Modern empirical benchmark: KS among best covariate shift detectors |
| Hamilton (1989) | Financial regime motivation — regimes persist months |
| Lo (2004) | Adaptive markets hypothesis — better framing than EMH for your work |
| Gu, Kelly & Xiu (2020) | ML in finance context, non-stationarity acknowledged |
| Grinold (1989) | IC framework used in information_coefficient.py |
| Dietterich (1998) | Statistical test comparison — justifies McNemar choice |
| Efron (1987) | BCa bootstrap — the exact method used in bootstrap_ci.py |
